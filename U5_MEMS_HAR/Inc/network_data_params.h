...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 3520, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (3520)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (3520)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 99788, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (99788)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (99788)

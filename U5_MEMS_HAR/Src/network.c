...
#define AI_NETWORK_MODEL_SIGNATURE     "0xdc50288b34db44d1a67d33c41d79453b"
...
#define AI_TOOLS_DATE_TIME   "2026-07-22T21:38:02+0530"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 1, 22), AI_STRIDE_INIT(4, 4, 4, 64, 64),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 32, 1, 3, 16), AI_STRIDE_INIT(4, 4, 128, 2048, 2048),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 24), AI_STRIDE_INIT(4, 4, 4, 128, 128),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 6, 1, 3, 32), AI_STRIDE_INIT(4, 4, 24, 768, 768),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 352, 64, 1, 1), AI_STRIDE_INIT(4, 4, 1408, 90112, 90112),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 99788, 1, 1),
    99788, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 3520, 1, 1),
    3520, NULL, NULL),
  ...
  &conv1d_conv2d_layer, 0x3b4d8844, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 2792);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2792);
    conv1d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 3416);
    conv1d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 3416);
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 64);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
    conv1d_output_array.data = AI_PTR(g_network_activations_map[0] + 64);
    conv1d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
    conv1d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    conv1d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    ...
    conv1d_1_output_array.data = AI_PTR(g_network_activations_map[0] + 1408);
    conv1d_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1408);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 2304);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2304);
    conv1d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 2432);
    conv1d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2432);
    conv1d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 8576);
    conv1d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 8576);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 8640);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 8640);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 98752);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 98752);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 99008);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 99008);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 99776);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 99776);
    return true;
  }

...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0xdc50288b34db44d1a67d33c41d79453b"
#define _STAI_NETWORK_DATETIME            "2026-08-22T18:00:37+0530"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 3, 1, 26, 6),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 3520),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 99788),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
static const ai_u32 conv1d_conv2d_t_in_0_shape_ch_const_u32 = 6;
static const ai_u32 conv1d_conv2d_t_out_0_shape_ch_const_u32 = 32;
...
static const ai_i32 conv1d_t_in_0_shape_ch_h_prod_const_s32 = 768;

static const ai_u32 conv1d_1_conv2d_t_in_0_shape_ch_const_u32 = 32;
static const ai_u32 conv1d_1_conv2d_t_out_0_shape_ch_const_u32 = 16;
...
static const ai_i32 conv1d_1_t_in_0_shape_ch_h_prod_const_s32 = 352;
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv1d_conv2d */
  {
    ...
    ai_float* conv1d_conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 64);
    const ai_u8* conv1d_conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 0);
    const ai_u8* conv1d_conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 2304);
    ai_float* conv1d_conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 3416);
  ...
  {
      ai_handle conv1d_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 64);
    const ai_handle conv1d_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 64);
  ...
  {
      const ai_float* conv1d_1_conv2d_t_in_0_ptr_const_f32 = (ai_float*)(net_ctx->_activations[0] + 64);
    ai_float* conv1d_1_conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 0);
    const ai_u8* conv1d_1_conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 2432);
    const ai_u8* conv1d_1_conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 8576);
    ai_float* conv1d_1_conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 3136);
  ...
  {
      ai_handle conv1d_1_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 1408);
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_dense */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 1408),
      .weights = (float*)(net_ctx->_weights[0] + 8640),
      .bias = (float*)(net_ctx->_weights[0] + 98752),
      .n_channel_in = 352,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(4, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 1408)});
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_1_dense */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 99008),
      .bias = (float*)(net_ctx->_weights[0] + 99776),
      .n_channel_in = 64,
      .n_channel_out = 3,
      .n_elements = 1,
    };
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_inputs[0] = activations[0] + 2792;
